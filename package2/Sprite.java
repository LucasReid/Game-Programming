...
public class Sprite {
	...
	public int getHeigh(){
		return image.getHeight(null);//the null can be specified as an image observer;
	}
	...
	public void draw(Graphics gc, int x, int y, int index){
		...
		gc.drawImage(image, x, y, x+getWidth(), y+getHeigh(), sx1, 0, sx2, getHeigh(), null);
		//takes image, the destination (x,y), source top left and right, then bottom left and right! and the observer is blank
